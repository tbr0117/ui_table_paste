			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testprj-display": {
								"semanticObject": "testprj",
								"action": "display",
								"description": "A MaterialPrj application.",
								"title": "MaterialPrj",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testprj",
									"url": sap.ui.require.toUrl("testprj")
								}
							}
						}
					}
